  ...
  return (
    <header className="relative z-30 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
      ...
      <div className="flex items-center gap-3">
        <a href="#cta" className="hidden text-sm font-medium hover:text-primary md:inline">Sign in</a>
        <a
          href="#cta"
    ...
    <section id="showcase" className="bg-foreground py-28 text-background">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <a href="#cta" className="inline-flex items-center gap-1 text-sm font-semibold underline decoration-2 underline-offset-4">
