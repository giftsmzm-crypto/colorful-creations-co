...
import { ArrowLeft, Eye, EyeOff, Lock, Mail, Palette } from "lucide-react";
    ...
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{ background: "var(--sunset)", animationDelay: "-5s" }}
        />
      </div>
      ...
      <section className="relative z-10 mx-auto grid min-h-[calc(100vh-92px)] max-w-6xl items-center gap-10 px-6 pb-16 lg:grid-cols-[1fr_440px]">
        <div className="max-w-2xl">
          <p className="text-sm font-bold uppercase tracking-widest text-primary">Welcome back</p>
          <h1 className="mt-4 text-5xl font-extrabold leading-[1.02] md:text-7xl">
            Sign in to your <span className="text-gradient-sunset">Palette</span> account.
          </h1>
          <p className="mt-6 max-w-xl text-lg text-muted-foreground md:text-xl">
            Continue managing your art, collecting favorites, and following artists.
          </p>
        </div>
        ...
        <div className="rounded-[2rem] border border-border bg-card/90 p-6 shadow-2xl shadow-foreground/10 backdrop-blur md:p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Use the email and password from your Palette account.
          </p>
